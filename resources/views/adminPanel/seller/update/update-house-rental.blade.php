    ...
    <div class="flex flex-col min-h-screen">
        ...
        <main class="flex flex-1 items-center justify-center p-4">
            <div class="container mx-auto my-8 p-8 bg-white rounded-lg shadow-lg">
                <h2 class="text-2xl font-bold text-black mb-4">update House Rental Form</h2>
                <form class="space-y-4" action="{{ route('house-rentals.update',$houseRental->id) }}" method="POST"
                    ...
                    <input name="contact_details" value="{{old('contact_details',$houseRental->contact_details)}}" type="text" placeholder="Contact Details" class="w-full p-3 border border-gray-300 rounded" required>
