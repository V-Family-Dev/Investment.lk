...
<main class="flex-grow flex flex-col items-center justify-center">
    <div class="container mx-auto my-8 p-8 bg-white rounded-lg shadow-lg">
        ...
        <form class="space-y-4" action="{{ route('plantation_sales.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="text" name="title" placeholder="Title" class="w-full p-3 border border-gray-300 rounded" required>
            <input type="text" name="plantation_type" placeholder="Plantation Type" class="w-full p-3 border border-gray-300 rounded" required>
