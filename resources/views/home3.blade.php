...
<body>
    ...
    <x-menu-title bgimage="images/building/build6.jpg" />

    <x-content-one bgimage="images/building/build11.png" bigimage="images/building/build4.jpg" smallimage="images/building/build3.jpg"/>
