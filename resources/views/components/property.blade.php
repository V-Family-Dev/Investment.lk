<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-[387.5px] h-[432px] bg-[#F9FCFF] p-4 rounded-lg shadow-md">
        ...
        <div class="space-y-4 mt-4">
            <div>
                <p class="text-[#000000] font-bold text-lg">Regal Ridge Estates</p>
            </div>
            <div class="flex items-center space-x-2">
                <img id="location" src="images/icons/location.png" class="w-[14.4px] h-[18px]">
                <p class="text-black text-[17px]">1000 W Redondo Beach Blvd, Gardena, CA</p>
            </div>
            <div class="flex justify-between w-full mt-2">
                <div class="flex items-center space-x-2">
                    <img id="Beds" src="images/icons/bed.png" class="w-[14.4px] h-[18px]">
                    <p class="text-black text-[17px]">Beds</p>
                </div>
                <div class="flex items-center space-x-2">
                    <img id="baths" src="images/icons/bathtub.png" class="w-[14.4px] h-[18px]">
                    <p class="text-black text-[17px]">Baths</p>
                </div>
                <div class="flex items-center space-x-2">
                    <img id="area" src="images/icons/fullscreen.png" class="w-[14.4px] h-[18px]">
