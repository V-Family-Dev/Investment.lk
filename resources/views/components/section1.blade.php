...
<div style="width: calc(65% * 1082px); height: 1082px; position: relative;">
    ...
    <div class="bg-transparent p-6 " style="position: absolute; top: calc(40%); left: 0; width: 100%; z-index: 10;">
        ...
        <div class="flex gap-4 mt-5">
            <!-- Photo 1 -->
            <div class="w-1/4">
                <img src="{{ asset('images/property/anju/Rectangle 41915.png') }}" alt="Photo 1" class="w-full h-auto rounded-lg shadow-md">
            </div>
            <!-- Photo 2 -->
            <div class="w-1/4">
                <img src="{{ asset('images/property/anju/Rectangle 41915.png') }}" alt="Photo 2" class="w-full h-auto rounded-lg shadow-md">
            </div>
            <!-- Photo 3 -->
            <div class="w-1/4">
                <img src="{{ asset('images/property/anju/Rectangle 41915.png') }}" alt="Photo 3" class="w-full h-auto rounded-lg shadow-md">
            </div>
            <!-- Photo 4 -->
            <div class="w-1/4">
                <img src="{{ asset('images/property/anju/Rectangle 41915.png') }}" alt="Photo 4" class="w-full h-auto rounded-lg shadow-md">
            </div>
        </div>
    </div>
...
<div class="bg-transparent p-6 mb-4 rounded-lg  flex gap-4" style="position: absolute; top: calc(60%); left: 0; width: 100%; z-index: 10;">
    ...
    <div class="flex-1 p-6 rounded-lg" style="background: linear-gradient(90deg, #FFD800 0%, #998200 100%);">
        <h2 class="text-white">3911 Firestone Blvd, South Gate, CA 90280, United States</h2>
    </div>

    <!-- Sub-component 2 -->
    <div class="flex-1 p-6 rounded-lg" style="background: linear-gradient(90deg, #FFD800 0%, #998200 100%);">
        <h2 class="text-white text-center">078 3378585</h2>
    </div>
